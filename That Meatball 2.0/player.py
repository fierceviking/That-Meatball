...
class Player:
    ...
    def __init__(self, ai_game):
        ...
        self.meatball_rect = standing_surface.get_rect(center=(self.x_position, self.y_position))
        self.jump_height = 20
        self.y_velocity = self.jump_height

        standing_surface = pygame.transform.scale(pygame.image.load("images/meatball.png"), (200, 200))
        self.jumping_surface = pygame.transform.scale(pygame.image.load("images/meatball.png"), (200, 200))
        self.background = pygame.transform.scale(pygame.image.load("images/Background.jpg"), (1920,1080))
